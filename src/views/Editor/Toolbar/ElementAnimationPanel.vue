    ...
    <div class="element-animation-panel">
        <div class="element-animation" v-if="handleElement">
            ...
            >
                ...
                <a-button class="element-animation-btn">
                    ...
                    {{ handleElementAnimationName || "点击选择动画" }}
                </a-button>
            </a-popover>
            <a-button class="element-animation-btn" v-else disabled>
        ...
        >
            <template #item="{ element, index }">
                <div
                    class="sequence-item"
                    :class="{ active: handleElement?.id === element.elId }"
                >
                    ...
                    <div class="handler">
                        ...
                        >
                            <IconCloseSmall
                                class="handler-btn"
                                @click="deleteAnimation(element.elId)"
                            />
                        </a-tooltip>
                    </div>
                </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        const currentSlideAnimations = computed<PPTAnimation[] | null>(
            () => store.getters.currentSlideAnimations
        );
        ...
        const handleElementAnimation = computed(() => {
            ...
            const animation = animations.find(
                item => item.elId === handleElement.value.id
            );
        ...
        const deleteAnimation = (elId: string) => {
            const animations = (currentSlideAnimations.value as PPTAnimation[]).filter(
                item => item.elId !== elId
            );
        ...
        const addAnimation = (type: string) => {
            ...
            const animations: PPTAnimation[] = currentSlideAnimations.value
                ? JSON.parse(JSON.stringify(currentSlideAnimations.value))
                : [];
            animations.push({
