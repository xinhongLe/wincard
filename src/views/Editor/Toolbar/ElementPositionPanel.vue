<template>
    <div class="element-positopn-panel">
        ...
        <a-button-group class="row">
            <a-button
                style="flex: 1;"
                @click="orderElement(handleElement, 'top')"
                ><IconSendToBack class="btn-icon" /> 置于顶层</a-button
            >
            <a-button
                style="flex: 1;"
                @click="orderElement(handleElement, 'bottom')"
                ><IconBringToFrontOne class="btn-icon" /> 置于底层</a-button
            >
        </a-button-group>
        <a-button-group class="row">
            <a-button
                style="flex: 1;"
                @click="orderElement(handleElement, 'up')"
                ><IconBringToFront class="btn-icon" /> 上移一层</a-button
            >
            <a-button
                style="flex: 1;"
                @click="orderElement(handleElement, 'down')"
                ><IconSentToBack class="btn-icon" /> 下移一层</a-button
            >
        </a-button-group>
        ...
        <a-button-group class="row">
            <a-tooltip
                ...
                title="左对齐"
            >
                <a-button style="flex: 1;" @click="alignElementToCanvas('left')"
                    ><IconAlignLeft
                /></a-button>
            </a-tooltip>
            <a-tooltip
            ...
            >
                <a-button
                    style="flex: 1;"
                    @click="alignElementToCanvas('horizontal')"
                    ><IconAlignVertically
                /></a-button>
            </a-tooltip>
            <a-tooltip
            ...
            >
                <a-button
                    style="flex: 1;"
                    @click="alignElementToCanvas('right')"
                    ><IconAlignRight
                /></a-button>
            </a-tooltip>
        </a-button-group>
        <a-button-group class="row">
            <a-tooltip
                ...
                title="上对齐"
            >
                <a-button style="flex: 1;" @click="alignElementToCanvas('top')"
                    ><IconAlignTop
                /></a-button>
            </a-tooltip>
            <a-tooltip
            ...
            >
                <a-button
                    style="flex: 1;"
                    @click="alignElementToCanvas('vertical')"
            ...
            >
                <a-button
                    style="flex: 1;"
                    @click="alignElementToCanvas('bottom')"
                    ><IconAlignBottom
                /></a-button>
            </a-tooltip>
        </a-button-group>
        ...
        <template v-if="handleElement.type !== 'line'">
            <div class="row">
                ...
                />
                <template
                    v-if="['image', 'shape'].includes(handleElement.type)"
                >
                    <a-tooltip
                        :mouseLeaveDelay="0"
                        :mouseEnterDelay="0.5"
