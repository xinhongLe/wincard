    ...
    >
        <div class="add-slide">
            <div class="btn" @click="createSlide()">
                <icon-plus class="icon" />添加幻灯片
            </div>
            <a-popover
                trigger="click"
                placement="bottomLeft"
                v-model:visible="presetLayoutPopoverVisible"
            >
                <template #content>
                    <layout-pool
                        @select="
                ...
                <div class="select-btn"><icon-down /></div>
            </a-popover>
        </div>
        ...
        >
            <template #item="{ element, index }">
                <div
                    ...
                    @mousedown="
                        $event => handleClickSlideThumbnail($event, index)
                    "
...
export default {
    ...
    setup() {
        ...
        // 缩略图右击菜单配置
        const contextmenusThumbnailItem = () => {
            return [
                {
                    text: "剪切",
                    subText: "Ctrl + X",
