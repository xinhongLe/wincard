    ...
    setup(props, { emit }) {
        ...
        const handleClip = () => {
            ...
            const position = {
                ...
                width:
                    ((topImgWrapperPosition.width - 100) / 100) * props.width,
                height:
                    ((topImgWrapperPosition.height - 100) / 100) * props.height
            };
        ...
        const moveClipRange = (e: MouseEvent) => {
            ...
            document.onmousemove = e => {
                ...
                if (targetLeft < 0) targetLeft = 0;
                    ...
                    targetLeft + originPositopn.width >
                ...
                if (targetTop < 0) targetTop = 0;
                    ...
                    targetTop + originPositopn.height >
        ...
        const scaleClipRange = (e: MouseEvent, type: ScaleClipRangeType) => {
            ...
            document.onmousemove = e => {
                ...
                if (ctrlOrShiftKeyActive.value) {
                    if (type === "b-r" || type === "t-l") {
                        moveY = moveX / aspectRatio;
                    }
                    if (type === "b-l" || type === "t-r") {
                        moveY = -moveX / aspectRatio;
                    }
                }
                ...
                if (type === "t-l") {
                    ...
                    if (
                        ...
                        moveX =
                            bottomPosition.width -
                            (originPositopn.left + originPositopn.width);
                    }
                    if (originPositopn.top + moveY < 0) {
                        moveY = -originPositopn.top;
                    }
