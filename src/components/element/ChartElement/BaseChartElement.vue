...
export default defineComponent({
    ...
    setup(props) {
        const size = computed(() =>
            Math.min(props.elementInfo.width, props.elementInfo.height)
        );
        ...
        const chartType = computed(() => {
            ...
            if (_chartType === "bar") {
                ...
                if (_options?.showArea) {
                    return "area";
                } else if (_options && _options.showLine === false) {
                    return "scatter";
                }
                return "line";
