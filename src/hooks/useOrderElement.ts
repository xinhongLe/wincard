    ...
    const getCombineElementLevelRange = (
        ...
        return {
            ...
            maxLevel: elementList.findIndex(
                _element =>
                    _element.id ===
                    combineElementList[combineElementList.length - 1].id
            )
        };
    };
